...
let EsbuildBinaryPath() : string =
  "/home/runner/.local/share/perla/0.25.6/package/bin/esbuild"
  |> Path.GetFullPath
...
let tryDownloadEsBuild() : Task<string option> =
  let url =
    "https://registry.npmjs.org/@esbuild/linux-x64/-/linux-x64-0.25.6.tgz"

  let compressedFile = "/home/runner/.local/share/perla/0.25.6/esbuild.tgz"
